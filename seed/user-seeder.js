...
//const db='mongodb+srv://Employee003:Employee@003@cluster0.mu0hyod.mongodb.net/?retryWrites=true&w=majority';
//mongoose.connect(db);
//mongoose.connect('localhost:27017');
mongoose.connect("mongodb://localhost:27017/EmployeeManagementSystem").then(()=>console.log("Connection is successful"))
...
var users=[
    ...
    new User({
        ...
        type: 'Abhisekh pradhan',
        email: 'abhisekhQ@outlook.com',
        password: bcrypt.hashSync('123456', bcrypt.genSaltSync(5), null),
        name: 'Hassan Qureshi',
        dateOfBirth: new Date('1990-05-26'),
        contactNumber: '0300-4814710',
